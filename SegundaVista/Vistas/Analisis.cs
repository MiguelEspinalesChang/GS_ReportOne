...
namespace SegundaVista.Vistas
{
    public partial class Analisis : Form
    {
        ...
        private void btnAnlizarRangoFecha_Click(object sender, EventArgs e)
        {
            ...
            var DocumentoRegistro = MongoConexion.DataBase.GetCollection<DatosPilot>("Datos");
            ...
            //var resutado = from d in DocumentoRegistro.FindAll()
            //               where d.id_pilot == txtIdMedidor.Text
            //               select (from i in d where i.Time >= FechaInicialRegistro && i.Time <= FechaFinalRegistro
